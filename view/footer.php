<footer>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="row row-cols">
                            ...
                            <div class="col-md-4 col-get-in-touch">
                                ...
                                <addres class="hidden-xs">
                                    <i class="fas fa-map-marker"></i> <span> 618 E. South Street, Suite
                                        510<br />Orlando, FL 32801</span>

                                </addres>
                                <p class="hidden-xs"><a href="tel:1855ORLCITY"><i class="fa fa-phone"></i>
                                        1.855.ORL.CITY</a></p>
        ...
        <div class="row row-cinza-escuro">
            <div class="container copyright-mobile">
                ...
                <p class="pull-right text-roxo">Created by Victor Antunes </p>
